...
* **Power Move:** To increase the number of sparse annotations for associated with each image, consider training a patch-based image classifier on the existing annotations and then use *it* to add additional annotations for you;
