...
* The best values for the parameters `start_iter`, `end_iter`, and `num_iter` are a function of the resolution of the image and number of sparse annotations provided (try different values for different datasets);
