...
### Tips
* **Speed Boost:** Resizing the dimensions of images increases the speed of Fast-MSS without significantly affecting the accuracy of the resulting mask [2]; remember to always use nearest neighbor interpolation when resizing masks.
